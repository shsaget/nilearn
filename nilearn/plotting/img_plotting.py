...
def plot_img_cbar_controled(img, cut_coords=None, output_file=None, display_mode='ortho',
             figure=None, axes=None, title=None, threshold=None,
             annotate=True, draw_cross=True, black_bg=False, colorbar=False,
             resampling_interpolation='continuous', vmin=None, vmax=None, cbar_vmin=None,
             cbar_vmax=None,  **kwargs):
    ...
    display = _plot_img_with_bg(
        ...
        black_bg=black_bg, colorbar=colorbar, vmin=vmin, vmax=vmax, cbar_vmin=cbar_vmin,
